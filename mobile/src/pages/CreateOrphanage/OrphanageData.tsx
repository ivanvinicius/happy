...
interface IOrphanageDataRouteProps {
  position: {
    latitude: number;
    longitude: number;
  }
...
export default function OrphanageData() {
  ...
  const { position } = route.params as IOrphanageDataRouteProps;
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TouchableOpacity style={styles.imagesInput} onPress={handleAddSelectImages}>
